import { PlusIcon, RectangleGroupIcon, TruckIcon, UserGroupIcon } from '@heroicons/react/20/solid'
...
const EmptyStates:FC<IEmptyStates> = ({name}) => {
  ...
  return (
    <div className="text-center">
      ...
      <h3 className="mt-2 text-sm font-semibold text-gray-900">No {name.toLowerCase()}s</h3>
